...
2. Test inference and save the inputs:
...
3. Run ONNX inference with an initial box, an initial image, and a single search image
   and save the visualization results:
     python test_onnx_inference.py \
...
4. Compare errors: the script prints error metrics automatically and warns when
